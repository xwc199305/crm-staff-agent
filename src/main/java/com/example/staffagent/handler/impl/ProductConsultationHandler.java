...
public class ProductConsultationHandler implements IntentHandler {
    ...
    public String handle(String query) {
        log.debug("Handling product consultation query: {}", query);
        return "Hello! Regarding product usage consultation, what specific aspects would you like to know about?";
    }
